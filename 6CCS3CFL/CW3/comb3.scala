...
val factorial = List(
  T_ID("result"), T_OP(":="), T_NUM(1), T_SEMI,
  T_ID("i"), T_OP(":="), T_NUM(1), T_SEMI,
  T_KWD("read"), T_ID("n"), T_SEMI,
  T_KWD("while"), T_LPAREN, T_ID("i"), T_OP("<"), T_LPAREN, T_ID("n"), T_OP("+"), T_NUM(1), T_RPAREN, T_RPAREN, T_KWD("do"), T_CLPAREN,
  T_ID("result"), T_OP(":="), T_ID("result"), T_OP("*"), T_ID("i"), T_SEMI,
  T_ID("i"), T_OP(":="), T_ID("i"), T_OP("+"), T_NUM(1), T_CRPAREN
)

Stmts.parse_all(factorial)
eval(Stmts.parse_all(factorial).head)
